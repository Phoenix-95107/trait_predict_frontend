...
export default function SignUpPage() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 mt-[46px] py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8">
          <div>
            <p className="mt-6 text-center text-2xl font-bold mb-14 text-[#363636] ">
              Sign Up to Faraseh
            </p>
          </div>
          ...
          <div className="relative">
            <div className="relative flex justify-center text-sm">
              <span className="px-2 font-medium text-base bg-gray-50 text-[#363636]">
                Or
              </span>
            </div>
          </div>
          ...
          <form className="mt-3 space-y-6" action="#" method="POST">
            <div className="flex flex-col gap-12 rounded-md shadow-sm -space-y-px">
              <div>
                <p className="text-xs px-3 font-semibold -mt-5">Full Name*</p>
                ...
                <input
                  ...
                  type="text"
                  required
                  className="appearance-none text-base font-medium rounded-none relative block w-full px-3 py-3  placeholder-[#AAAAAA] text-gray-900 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm"
          ...
          <div className="text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link
                href="/signin"
                className="font-medium text-black hover:text-indigo-500 underline"
              >
                Sign in
              </Link>
            </p>
